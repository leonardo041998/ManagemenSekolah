            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/students/create" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label style="font-weight:bold" for="exampleInputEmail1">NISN</label>
                                ...
                                <div class="form-floating {{ $errors->has('nama_lengkap') ? 'has-error' : '' }} ">
                                    <label style="font-weight:bold" for="exampleInputEmail1">Nama Lengkap</label>
                                ...
                                <div class="form-floating {{ $errors->has('tmpt_lahir') ? 'has-error' : '' }} ">
                                    <label style="font-weight:bold" for="exampleInputEmail1">Tempat Lahir</label>
                                ...
                                <div class="form-floating {{ $errors->has('tgl_lahir') ? 'has-error' : '' }} ">
                                    <label style="font-weight:bold" for="exampleInputEmail1">Tanggal Lahir</label>
                                ...
                                <div class="form-group {{ $errors->has('jenis_kelamin') ? 'has-error' : '' }}">
                                    <label style="font-weight:bold" for="jenis_kelamin">Pilih Jenis Kelamin </label> <br>
                                ...
                                <div class="form-floating {{ $errors->has('agama') ? 'has-error' : '' }} ">
                                    <label style="font-weight:bold" for="exampleInputEmail1">Agama</label>
                                ...
                                <div class="form-floating {{ $errors->has('nama_ibu') ? 'has-error' : '' }} ">
                                    <label style="font-weight:bold" for="exampleInputEmail1">Nama Ibu</label>
                                ...
                                <div class="form-floating {{ $errors->has('nama_ayah') ? 'has-error' : '' }} ">
                                    <label style="font-weight:bold" for="exampleInputEmail1">Nama Ayah</label>
                                ...
                                <div class="form-floating {{ $errors->has('pkrj_ibu') ? 'has-error' : '' }} ">
                                    <label style="font-weight:bold" for="exampleInputEmail1">Pekerjaan Ibu</label>
                                ...
                                <div class="form-floating {{ $errors->has('pkrj_ayah') ? 'has-error' : '' }} ">
                                    <label style="font-weight:bold" for="exampleInputEmail1">Pekerjaan Ayah</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating {{ $errors->has('nama_wali') ? 'has-error' : '' }} ">
                                    <label style="font-weight:bold" for=" exampleFormControlTextarea1">Nama Wali</label>
                                ...
                                <div class="form-floating {{ $errors->has('alamat') ? 'has-error' : '' }} ">
                                    <label style="font-weight:bold" for=" exampleFormControlTextarea1">Alamat</label>
                                ...
                                <div class="form-floating {{ $errors->has('rt') ? 'has-error' : '' }} ">
                                    <label style="font-weight:bold" for=" exampleFormControlTextarea1">RT</label>
                                ...
                                <div class="form-floating {{ $errors->has('rw') ? 'has-error' : '' }} ">
                                    <label style="font-weight:bold" for=" exampleFormControlTextarea1">RW</label>
                                ...
                                <div class="form-floating {{ $errors->has('kelurahan') ? 'has-error' : '' }} ">
                                    <label style="font-weight:bold" for=" exampleFormControlTextarea1">Kelurahan</label>
                                ...
                                <div class="form-floating {{ $errors->has('kecamatan') ? 'has-error' : '' }} ">
                                    <label style="font-weight:bold" for=" exampleFormControlTextarea1">Kecamatan</label>
                                ...
                                <div class="form-floating {{ $errors->has('no_telp') ? 'has-error' : '' }} ">
                                    <label style="font-weight:bold" for="exampleFormControlTextarea1">Nomor Telepon</label>
