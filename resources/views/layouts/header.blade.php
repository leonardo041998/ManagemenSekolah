<div class="header">
    <div class="header-left">
        <a href="index.html" class="logo"> <img src="{{ asset('admin/assets/img/logo9.png') }}" alt="logo">
            <span class="logoclass"></span> </a>
        <a href="index.html" class="logo logo-small"> <img src="{{ asset('admin/assets/img/logo10.png') }}" alt="Logo"
